    ...
    <main dir="rtl" className="public-shell min-h-dvh overflow-x-clip bg-[#07110e] text-zinc-100">
      ...
      <section className="relative isolate overflow-hidden border-b border-white/8">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-14 sm:px-8 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16 lg:px-10 lg:py-24">
          <div>
            ...
            <h1 className="mt-6 max-w-3xl text-4xl font-black leading-[1.14] tracking-[-0.035em] text-white sm:text-[2.75rem] lg:text-5xl">تشغيل تجارتك الرقمية،<br />بوضوح من أول طلب.</h1>
      ...
      <section id="features" className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-[0.76fr_1.24fr] lg:gap-16">
          <div className="lg:sticky lg:top-10 lg:self-start">
            <h2 className="max-w-md text-3xl font-black leading-[1.22] tracking-[-0.03em] text-white sm:text-4xl">مساحة تشغيل واحدة لكل ما يخص متجرك.</h2>
      ...
      <section id="workflow" className="border-y border-white/8 bg-[#091913] py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          <div className="max-w-2xl"><h2 className="text-3xl font-black leading-[1.22] tracking-[-0.03em] text-white sm:text-4xl">لا تحتاج إلى خبرة تقنية لتبدأ.</h2><p className="mt-5 text-base font-semibold leading-8 text-zinc-300">تبدأ من الأساسيات التي يحتاجها متجرك، ثم تتوسع في البوت والفريق والحملات عندما تصبح مستعدًا.</p></div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-[1.04fr_0.96fr] lg:items-start lg:gap-16">
          <div>
            <h2 className="max-w-2xl text-3xl font-black leading-[1.22] tracking-[-0.03em] text-white sm:text-4xl">من الخدمة إلى التجديد، لا تفقد أي تفصيلة.</h2>
      ...
      <section id="storefront" className="border-y border-emerald-300/15 bg-[#0c2119] py-20 sm:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.96fr_1.04fr] lg:items-center lg:px-10">
          <div>
            ...
            <h2 className="mt-6 max-w-xl text-3xl font-black leading-[1.22] tracking-[-0.03em] text-white sm:text-4xl">موقع خدمات خاص بكل تاجر.</h2>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
        <div className="max-w-2xl"><h2 className="text-3xl font-black leading-[1.22] tracking-[-0.03em] text-white sm:text-4xl">اختر باقة تتماشى مع مرحلة متجرك.</h2><p className="mt-5 text-base font-semibold leading-8 text-zinc-400">ابدأ التجربة بلا دفع. عند الانتهاء، تجدّد من محفظة المنصة بالباقة والمدة التي تختارها.</p></div>
